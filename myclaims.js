...
function getER(){
    ...
    xhr.open("GET","http://localhost:8080/TRMS/myreimburse?userid=" + empID,true);
    xhr.send();
}
...
function loadER(er){
    ...
    var table = document.createElement("table");
        ...
        // Insert JSON data to the table as rows.
        ...
        // Insert the newly created table with the JSON data to a container.
